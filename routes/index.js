...
exports.adduser = function(req, res){
    ...
    if(req.query.name&&req.query.password){
        ...
        var doc = {
            sex     : 0,
            age     : 1,//1个月
            tel     : config.productInfo.tel,
            email   : config.productInfo.email,
        ...
        db.query(sql['insert'], function(result){
            fun.jsonTips(req, res, 2000, config.Code2X[2000], result);
        })
...
exports.usercount = function (req, res){
    ...
    if (req.query.name&&req.query.value) {
        ...
        var sql = {
            name    : 'name="'+doc['countvalue']+'"',
            tel     : 'tel ="'+doc['countvalue']+'"',
        ...
        if (sql[req.query.name]) {
            ...
            db.query(sqlResult, function(result){
                ...
                fun.jsonTips(req, res, 2000, config.Code2X[2000], result[0]['count(*)']);
            })
        }else{
            fun.jsonTips(req, res, 1025, config.Code1X[1025], null);
        }
